...
const FilterFormMCU: React.FC<FilterFormMCUProps> = ({ onApply, onReset }) => {
  const {
    control,
    handleSubmit,
    register,
  ...
  return (
    <>
      <h2 className="text-xl font-bold mb-6">Tambah Data MCU</h2>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <SelectField
            label="Hasil MCU"
            {...register('hasil_mcu', { required: 'Hasil MCU wajib dipilih' })}
