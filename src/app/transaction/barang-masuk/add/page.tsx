...
export default function TambahDataBarangMasukForm() { 
  ...
  const onSubmit = async (dataAsset: BarangMasuk) => {
    try {
      // Step 1: Create Barang Masuk record
      const createPayload = {
      ...
      const updatePayload = { 
        ...
        stock: stock + dataAsset.jumlah_masuk,
      };
      ...
      // Step 3: Redirect to barang masuk list
    ...
    <div className="relative mx-auto">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center w-full mb-4 gap-4"> 
          <ContentHeader className="m-0" title="Tambah Data Barang Masuk" /> 
          <div className="flex gap-2">
            <ButtonDisabled type="button" onClick={() => router.push('/transaction/barang-masuk/')} className="px-6">
              Kembali
            </ButtonDisabled> 
